CREATE DATABASE  IF NOT EXISTS `dbcompany` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `dbcompany`;
...
CREATE TABLE `departament` (
  ...
  CONSTRAINT `chk_dept_date1` CHECK ((`Dept_create_date` <= `Mgr_start_date`)),
...
INSERT INTO `dependent` VALUES ('123456789','Alice','F','1988-12-30',10,'Daughter'),('123456789','Elizabeth','F','1967-05-05',10,'Spouse'),('123456789','Michael','M','1988-01-04',10,'Son'),('333445555','Alice','F','1986-04-05',10,'Daughter'),('333445555','Joy','F','1958-05-03',10,'Spouse'),('333445555','Theodore','M','1983-10-25',10,'Son'),('987654321','Abner','M','1942-02-28',10,'Spouse');
...
CREATE TABLE `dept_locations` (
  ...
  CONSTRAINT `fk_dept_locations1` FOREIGN KEY (`Dnumber`) REFERENCES `departament` (`Dnumber`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-31 17:20:37
